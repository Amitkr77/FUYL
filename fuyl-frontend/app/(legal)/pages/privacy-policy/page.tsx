...
const FALLBACK_SECTIONS = [
  ...
  { heading: 'Data Sharing', body: 'We share your data only with partners required to fulfil your order — logistics providers (name and address) and payment processors (Razorpay). We do not sell, rent or trade your personal information to any third parties for marketing purposes.' },
  { heading: 'Cookies', body: 'We use essential cookies to keep you logged in and remember your cart. We use analytics cookies (anonymised) to understand how visitors use our site. You can disable non-essential cookies in your browser settings.' },
  { heading: 'Data Security', body: 'All data is transmitted over HTTPS. Payment data is processed by Razorpay (PCI-DSS compliant). We store only what is necessary and review our data practices regularly.' },
  {
    heading: 'Your Rights',
    body: [
  ...
  { heading: 'Contact', body: 'For any privacy-related queries, email us at support@fuyl.in. We aim to respond within 5 business days.' },
]
