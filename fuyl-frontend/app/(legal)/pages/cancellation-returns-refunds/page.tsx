...
const FALLBACK_SECTIONS = [
  { heading: '30-Day Money-Back Guarantee', body: 'We stand behind FUYL COMPLETE+ with a 30-day money-back guarantee. If you have taken the product consistently for 30 days and do not feel a meaningful improvement in your energy, gut health or overall wellbeing, contact us for a full refund. No questions asked.' },
  {
  ...
  { heading: 'Refund Method', body: 'Refunds are issued to the original payment method. UPI and card refunds typically appear within 5–7 business days. Bank transfers may take up to 10 business days. We will notify you by email once the refund is processed.' },
  {
  ...
  { heading: 'Contact for Returns', body: 'Email: support@fuyl.in · WhatsApp: +91 9274787827 · Hours: Monday–Saturday, 9am–6pm IST' },
]
