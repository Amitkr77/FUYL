...
export const ORDER_STATUS_META: Record<string, { label: string; color: string; bg: string; dot: string }> = {
  ...
  packed:     { label: 'Ready to Ship', color: '#92400E', bg: '#FFFBEB', dot: '#D97706' },
  dispatched: { label: 'Shipped',  color: '#075985', bg: '#E0F2FE', dot: '#0EA5E9' },
  shipped:    { label: 'Shipped',  color: '#075985', bg: '#E0F2FE', dot: '#0EA5E9' },
  in_transit: { label: 'In Transit',  color: '#065F46', bg: '#ECFDF5', dot: '#10B981' },
  out_for_delivery: { label: 'Out for Delivery', color: '#065F46', bg: '#ECFDF5', dot: '#10B981' },
