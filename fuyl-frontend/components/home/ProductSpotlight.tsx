      ...
      <div className="grid grid-cols-1 gap-8 lg:gap-0 lg:grid-cols-2 container-brand">
        ...
        <div className="flex flex-col gap-6 px-0 lg:px-8">
          <ScrollReveal>
            ...
            <h3 className="mt-1 text-white/60 font-normal">Daily Nutrition Powder</h3>
            <p className="text-body-lg mt-4 text-white/65 text-justify">
              ...
              antioxidant protection, skin & cellular protection. Built for
              the urban Indian who wants complete daily nutrition without the
              complexity.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={100}>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {BENEFITS.map(({ title, text }) => (
                ...
                >
                  <h3 className="text-body-md font-semibold text-white">{title}</h3>
