                  ...
                  <div>
                    ...
                    {notifTotal > 0 && (
                      <p className="text-xs text-slate-400 mt-0.5">
                        {notifTotal} pending order{notifTotal !== 1 ? "s" : ""}
                      </p>
                    )}
                  </div>
                  {notifTotal > 0 && (
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl shadow-slate-900/20 overflow-hidden border border-slate-100">
                ...
                filtered.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <item.Icon
                          className={`w-4 h-4 ${isActive ? "text-[#558476]" : "text-slate-500"}`}
                        />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p
                          className={`text-sm font-medium ${isActive ? "text-slate-900" : "text-slate-700"}`}
                        >
                          {item.label}
                        </p>
            ...
            <div className="flex items-center gap-4 px-4 py-2.5 border-t border-slate-100 bg-slate-50/60">
              <div className="flex items-center gap-1.5 text-[10px] text-slate-400">
                <kbd className="bg-white border border-slate-200 rounded px-1 py-0.5 font-medium leading-none">
                  ↑↓
                </kbd>
                Navigate
              </div>
